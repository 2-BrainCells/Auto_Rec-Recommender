...
from hpo import run
from utils import train_ranking, evaluator, evaluate_recommendation_model, plot_metrics, generate_autorec_recommendations, display_recommendations
...
def auto_rec_runner():
    ...
    sample_users = [0, 5, 10] if test_inter_mat.shape[0] > 10 else [0]
    ...
    evaluate_recommendation_model(net, test_iter, test_inter_mat)
